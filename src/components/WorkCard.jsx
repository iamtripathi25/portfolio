      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="border-t border-neutral-800">
          {WorkData.map((item, index) => (
            ...
            >
              {/* Counts up from the earliest role, so a number stays with its entry. */}
              <p className="text-sm font-semibold tabular-nums text-[#F2613F]">
                {String(WorkData.length - index).padStart(2, '0')}
              </p>
              ...
              <div>
                ...
                <div className="mt-2 flex flex-wrap items-center gap-3">
                  ...
                  {item.type && (
                    <span className="rounded-full border border-neutral-800 px-3 py-1 text-[0.65rem] font-semibold uppercase tracking-[0.18em] text-neutral-400">
                      {item.type}
                    </span>
                  )}
                </div>
